  ...
  renderProductInfo() {
    ...
    fetch(
      ...
      .then((responseText) => {
        ...
        // Variant features
        const featureInformation = html.getElementById(
          `variant-features-${this.dataset.section}`
        );
        const spikeData = featureInformation
          .querySelector(`#variant-features--data`)
          .getAttribute("data-feature-spike");
